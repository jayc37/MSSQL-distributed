...
begin
	...
	begin distributed tran
		insert into CHINHANH values (@IDCHINHANH, @TENCHINHANH, 'CN3', @SODIENTHOAI) -- THAY 'CN3' = 'CN2' NẾU LÀ MÁY TRẠM 2 (TRẠM 3 TƯƠNG TỰ)
		insert into QLVT_LINKED_SERVER.qlvattu.dbo.ChiNhanh values (@IDCHINHANH, @TENCHINHANH, 'CN3', @SODIENTHOAI)
	commit tran
end
go
-- delete
...
begin
	...
	begin distributed tran
		...
		insert into QLVT_TRAM_2.QUANLYCHUOINHAHANG.dbo.NGUYENLIEU values(@IDNGUYENLIEU,@TENNGUYENLIEU,@TRANGTHAI,@MOTA,@SOLUONG,@IDLOAINGUYENLIEU,@DONVITINH,@GIANHAP)
	commit tran
end
-- delete
go
...
begin
	...
	begin distributed tran
		...
		delete QLVT_TRAM_2.QUANLYCHUOINHAHANG.dbo.NGUYENLIEU where idnguyenlieu = @IDNGUYENLIEU
...
begin
	set xact_abort on
	begin distributed tran
		insert BAN values (@IDBAN, @TENBAN, @TRANGTHAI,'CN3')
		insert QLVT_LINKED_SERVER.QUANLYCHUOINHAHANG.dbo.BAN values (@IDBAN, @TENBAN, @TRANGTHAI,'CN3')
	commit tran
end
-- delete
go
...
begin
	insert QLVT_LINKED_SERVER.QUANLYCHUOINHAHANG.dbo.bophan values (@idbophan,@tenbophan,@mota,'CN3',@sodienthoai)
	insert bophan values (@idbophan,@tenbophan,@mota,'CN3',@sodienthoai)
end
--sửa
