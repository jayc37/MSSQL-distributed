...
begin
	...
	begin distributed tran
		insert into CHINHANH values (@IDCHINHANH, @TENCHINHANH, 'CN1', @SODIENTHOAI) -- THAY 'CN1' = 'CN2' NẾU LÀ MÁY TRẠM 2 (TRẠM 3 TƯƠNG TỰ)
		insert into QLVT_LINKED_SERVER.qlvattu.dbo.ChiNhanh values (@IDCHINHANH, @TENCHINHANH, 'CN1', @SODIENTHOAI)
	commit tran
end
go
-- delete
...
begin
	...
	begin distributed tran
		...
		insert into QLVT_TRAM_2.QUANLYCHUOINHAHANG.dbo.NGUYENLIEU values(@IDNGUYENLIEU,@TENNGUYENLIEU,@TRANGTHAI,@MOTA,@SOLUONG,@IDLOAINGUYENLIEU,@DONVITINH,@GIANHAP) -- nếu là trạm 1 sẽ insert vào 3 trạm còn lại.
...
begin
	...
	begin distributed tran
		...
		delete QLVT_TRAM_2.QUANLYCHUOINHAHANG.dbo.NGUYENLIEU where idnguyenlieu = @IDNGUYENLIEU -- NẾU LÀ TRẠM 1 INSERT VÀO 3 TRẠM CÒN LẠI
...
begin
	...
	begin distributed tran
		...
		update QLVT_TRAM_2.QUANLYCHUOINHAHANG.dbo.NGUYENLIEU
		SET TENNGUYENLIEU = @TENNGUYENLIEU,trangthai =  @TRANGTHAI,MOTA = @MOTA,SOLUONG = @SOLUONG, IDNGUYENLIEU = @IDLOAINGUYENLIEU,DONVITINH = @DONVITINH,GIANHAP = @GIANHAP
		where idnguyenlieu = @IDNGUYENLIEU
...
begin
	-- insert
		...
		insert into KhachHang values (@IDKHACHHANG, @TENKHACHHANG, @SODIENTHOAI,@DIACHI)
		insert into QLVT_TRAM_2.QUANLYCHUOINHAHANG.dbo.KhachHang values (@IDKHACHHANG, @NGAYSINH,@THONGTINKHAC, @PHAI)
end
go
-- delete
...
-- kiểm tra mã khách hàng
	...
	begin distributed tran
		...
		delete QLVT_TRAM_2.QUANLYCHUOINHAHANG.dbo.KhachHang where idkhachhang = @IDKHACHHANG
	commit tran
end
go
-- update
...
begin
	...
	begin distributed tran
		...
		update QLVT_TRAM_2.QUANLYCHUOINHAHANG.dbo.KhachHang
...
begin
	...
	-- insert
		...
		insert into NHACUNGCAP values (@IDNHACUNGCAP, @TENNHACUNGCAP, @DIACHI)
		insert into QLVT_TRAM_2.QUANLYCHUOINHAHANG.dbo.NHACUNGCAP values (@IDNHACUNGCAP, @SODIENTHOAI)
end
go
-- delete
...
begin
	...
	begin distributed tran
		...
		delete QLVT_TRAM_2.QUANLYCHUOINHAHANG.dbo.NHACUNGCAP where idnhacungcap = @IDNHACUNGCAP
	commit tran
end
go
-- update
...
begin
	...
	begin distributed tran
		...
		update QLVT_TRAM_2.QUANLYCHUOINHAHANG.dbo.NHACUNGCAP
...
begin
	set xact_abort on
	begin distributed tran
		insert BAN values (@IDBAN, @TENBAN, @TRANGTHAI,'CN1')
		insert QLVT_LINKED_SERVER.QUANLYCHUOINHAHANG.dbo.BAN values (@IDBAN, @TENBAN, @TRANGTHAI,'CN1')
	commit tran
end
-- delete
go
...
as
begin
	select T1.idkhachhang, T1.tenkhachhang, T1.sodienthoai, t2.ngaysinh, T1.diachi,t2.thongtinkhac,t2.phai
	from
		(select * from QLVT_TRAM_2.quanlychuoinhahang.dbo.KhachHang) T2
...
as
begin
	select T1.idnhacungcap, t1.tennhacungcap, t1.diachi, t2.sodienthoai
	from
		(select * from QLVT_TRAM_2.quanlychuoinhahang.dbo.nhacungcap) T2
		join (select * from nhacungcap) T1
		on T1.idnhacungcap = T2.idnhacungcap
end
go
alter proc sp_get_kho
as
begin
...
go
---
create proc sp_get_rp_nhanvien
as
...
alter proc sp_get_chitietho --exec sp_get_chitietho N'kem trà xanh'
	 @tennguyenlieu nvarchar(40)
	 as
	 begin
...
begin
	insert QLVT_LINKED_SERVER.QUANLYCHUOINHAHANG.dbo.bophan values (@idbophan,@tenbophan,@mota,'CN1',@sodienthoai)
	insert bophan values (@idbophan,@tenbophan,@mota,'CN1',@sodienthoai)
end
--sửa
